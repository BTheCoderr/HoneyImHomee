      ...
      <header className="sticky top-0 z-50 bg-honey-cream/95 backdrop-blur-sm shadow-cozy">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            >
              <span className="font-display font-bold text-honey-sage-deep tracking-brand text-xl sm:text-2xl uppercase">
                Honey, I&apos;m Home
              </span>
            </button>
            <button
              onClick={() => navigate('/')}
              className="text-honey-sage-deep hover:text-honey-rose-deep transition-colors font-medium"
            >
              ← Back to Home
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <h1 className="font-serif text-4xl font-bold text-honey-sage-deep mb-8">Order Your Meals</h1>
